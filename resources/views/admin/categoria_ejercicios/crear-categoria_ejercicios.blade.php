...
@section('contenido')
    ...
    <form id="crear-categoria_ejercicio" class="form-horizontal col-md-6"  >
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Nueva Categoria de Ejercicio<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                    ...
                    <div class="col-md-12">
                        <fieldset>
                            ...
                            <div id="nombre-field" class="form-group">
                                <label class="col-lg-3 control-label">Categoria de Ejercicio:</label>
                                <div class="col-lg-9">
...
@section('scripts')
    <script type="text/javascript">
        ...
        //enviar formulario
        $("#crear-categoria_ejercicio").submit(function(e) {

            $.ajax({
                type: 'post',
                url: "{{route('categoria_ejercicios.guardar')}}",
                data:  $("#crear-categoria_ejercicio").serialize(),
                dataType: 'json',
                success: function(data){
                    swal("Bien!", "Los datos se guardaron correctamente.", "success");
                    //resetear estilos
                    $('.form-group').removeClass("has-error has-feedback");
                    $('#crear-categoria_ejercicio').find('.form-control-feedback').html('');
                    $('#crear-categoria_ejercicio').find('.help-block').html('');
                    $('#crear-categoria_ejercicio')[0].reset();
                },
                error: function(data){
                    //resetear estilos
                    $('.form-group').removeClass("has-error has-feedback");
