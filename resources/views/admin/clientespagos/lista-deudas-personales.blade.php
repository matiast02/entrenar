...
@section('contenido')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Lista de deudas<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
    ...
    <script type="text/javascript">
        window.onload = function datos() {
            ...
            $('#clientepago-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'mes_sin_pagar', name: 'mes_sin_pagar'},
        ...
        function eliminar(id){
            swal({
                ...
                text: "Esta a punto de borrar una deuda!",
                type: "warning",
                ...
                $.ajax({
                    ...
                    success: function(data){
                        swal(
                            "Eliminado!",
                            "La deuda fue eliminada correctamente.",
                            "success"
                        );
