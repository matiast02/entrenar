...
@section('contenido')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Lista de Deportes<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
        ...
        <div class="panel-body">
            <table class="table datatable-responsive-row-control dataTable no-footer dtr-column" id="deportes-table" role="grid">
                <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Creado</th>
    ...
    <script type="text/javascript">
        ...
        function eliminar(id){
            swal({
                ...
                text: "Esta a punto de borrar un deporte!",
                type: "warning",
                ...
                $.ajax({
                    ...
                    success: function(data){
                        swal(
                                "Eliminado!",
                                "El deporte fue eliminado correctamente.",
                                "success"
                        );
                        $('#deportes-table').DataTable().ajax.reload();
                    },
                    error: function(data) {
