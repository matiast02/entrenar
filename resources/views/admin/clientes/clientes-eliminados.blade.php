...
@section('contenido')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Clientes eliminados<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
    ...
    <script type="text/javascript">
        window.onload = function datos() {
            ...
            $('#clientes-table').DataTable({
                ...
                ajax: '{!! route('clientes.eliminados.datatable') !!}',
                columns: [
                    {data: 'foto', name: 'foto'},
        ...
        function restaurar(id){
            swal({
                ...
                text: "Esta a punto de restaurar un cliente!",
                type: "warning",
                ...
                $.ajax({
                    type: 'post',
                    url: 'eliminados/restaurar/'+id,
                    data : {"_token": "{{ csrf_token() }}"},
                    dataType: 'json',
                    success: function(data){
                        swal(
                            "Restaurado!",
                            "El cliente fue restaurado correctamente.",
                            "success"
                        );
