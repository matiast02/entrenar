...
@section('contenido')
    ...
    <form id="editar-serie" class="form-horizontal col-md-6">
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Modificar Serie<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                    ...
                    <div class="col-md-12">
                        <fieldset>
                            ...
                            <div id="cantidad_series-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name ="cantidad_series" value="{{$serie->cantidad_series}}">
                            ...
                            <div id="peso_corporal-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"  name="peso_corporal" class="form-control" value="{{$serie->peso_corporal}}">
                                    <div class="form-control-feedback"></div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div id="peso_externo-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"  name="peso_externo" class="form-control" value="{{$serie->peso_externo}}">
                                    <div class="form-control-feedback"></div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div id="potencia_impulsiva-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"  name="potencia_impulsiva" class="form-control" value="{{$serie->potencia_impulsiva}}">
                                    <div class="form-control-feedback"></div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div id="velocidad_impulsiva-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"  name="velocidad_impulsiva" class="form-control" value="{{$serie->velocidad_impulsiva}}">
                                    <div class="form-control-feedback"></div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            ...
                            <div id="fuerza_impulsiva-field" class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"  name="fuerza_impulsiva" class="form-control" value="{{$serie->fuerza_impulsiva}}">
                                    <div class="form-control-feedback"></div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        //enviar formulario
        $("#editar-serie").submit(function(e) {

            $.ajax({
                type: 'patch',
                url: "{{route('series.update',$serie->id)}}",
                data:  $("#editar-serie").serialize(),
                dataType: 'json',
                success: function(data){
                    swal("Bien!", "Los datos se guardaron correctamente.", "success");
                    //resetear estilos
                    $('.form-group').removeClass("has-error has-feedback");
                    $('#editar-serie').find('.form-control-feedback').html('');
                    $('#editar-serie').find('.help-block').html('');
                    $('#editar-serie')[0].reset();
                    //window.location.replace("{route('listar.series')}}");
                    //window.location.href="{route('listar.series')}}";
