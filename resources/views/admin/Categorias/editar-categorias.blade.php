...
@section('contenido')
    ...
    <form id="editar-categoria" class="form-horizontal col-md-6">
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Modificar Categoria<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
    ...
    <script type="text/javascript">
        ...
        $("#editar-categoria").submit(function(e) {
            ...
            $.ajax({
                ...
                data:  $("#editar-categoria").serialize(),
                dataType: 'json',
                success: function(data){
                    swal("Bien!", "Los datos se guardaron correctamente.", "success");
                    //resetear estilos
                    $('.form-group').removeClass("has-error has-feedback");
                    $('#editar-categoria').find('.form-control-feedback').html('');
                    $('#editar-categoria').find('.help-block').html('');
                    $('#editar-categoria')[0].reset();

                    var delay = 1280;
                    setTimeout(function(){window.location.replace("{{route('listar.categorias')}}") }, delay);
                },
                error: function(data){
                    //resetear estilos
                    $('.form-group').removeClass("has-error has-feedback");
