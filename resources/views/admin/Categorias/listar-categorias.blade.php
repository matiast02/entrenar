...
@section('contenido')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Lista de Categorias<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
        ...
        <div class="panel-body">
            <table class="table datatable-responsive-row-control dataTable no-footer dtr-column" id="categorias-table" role="grid">
                <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Creado</th>
    ...
    <script type="text/javascript">
        window.onload = function datos() {
            ...
            $('#categorias-table').DataTable({
                ...
                ajax: '{!! route('categorias.datatable') !!}',
                columns: [
        ...
        function eliminar(id){
            swal({
                ...
                text: "Esta a punto de borrar una categoria!",
                type: "warning",
