...
class UpdateEvaluacionesTableAddNullableAllCol extends Migration
{
    ...
    public function up()
    {
        Schema::table('evaluaciones', function (Blueprint $table) {
            $table->float('maximo_peso')->nullable()->change(); //MAXIMO PESO (Peso Externo): Peso Muerto y Remo
            ...
            $table->float('salto_abalacob')->nullable()->change();//MAXIMO SALTO (ALTURA) EN MTS: Salto Abalacob, cmj y sj.
